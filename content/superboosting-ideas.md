...
One thing you’ll observe amongst all the above questions is that they are all _what_ questions. These start the conversation but are often only surface-level. An entire set of **_why _**questions that can unravel the birth of the answer to the \_what \_questions can be helpful for further roots of inspiration.
